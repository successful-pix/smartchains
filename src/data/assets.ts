/**
 * Supported display assets. `id` is the market-data provider id (CoinGecko).
 * Keeping this list separate from the API service means the provider can be
...
export const SUPPORTED_ASSET_IDS = SUPPORTED_ASSETS.map((a) => a.id);

export function findAsset(id: string): SupportedAsset | undefined {
